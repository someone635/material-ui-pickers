...
var YearSelection = function YearSelection(_ref) {
  ...
  return createElement("div", {
    ...
    return createElement(Year$1, {
      ...
      disabled: Boolean(disablePast && utils.isBeforeYear(year, utils.date()) || disableFuture && utils.isAfterYear(year, utils.date()) || !!shouldDisableYear && shouldDisableYear(yearNumber))
...
var MonthSelection = function MonthSelection(_ref) {
  ...
  var shouldDisableMonthFinal = function shouldDisableMonthFinal(month) {
    var now = utils.date();
    ...
    return isBeforeFirstEnabled || isAfterLastEnabled || !!shouldDisableMonth && shouldDisableMonth({
      month: utils.getMonth(month),
      year: utils.getYear(month)
    });
  };
  ...
  return createElement("div", {
    ...
    return createElement(Month, {
      ...
      disabled: shouldDisableMonthFinal(month)
    }, monthText);
  }));
};
...
var Picker = function Picker(_ref) {
  var date = _ref.date,
      ...
      shouldDisableMonth = _ref.shouldDisableMonth,
      shouldDisableYear = _ref.shouldDisableYear,
      rest = _objectWithoutProperties(_ref, ["date", "views", "disableToolbar", "onChange", "openTo", "minDate", "maxDate", "ToolbarComponent", "orientation", "shouldDisableMonth", "shouldDisableYear"]);
...
//# sourceMappingURL=Picker-6b005cc1.js.map
