...
exports.Picker = function (_a) {
    var _b, _c;
    var date = _a.date, views = _a.views, disableToolbar = _a.disableToolbar, onChange = _a.onChange, openTo = _a.openTo, unparsedMinDate = _a.minDate, unparsedMaxDate = _a.maxDate, ToolbarComponent = _a.ToolbarComponent, orientation = _a.orientation, shouldDisableMonth = _a.shouldDisableMonth, shouldDisableYear = _a.shouldDisableYear, rest = __rest(_a, ["date", "views", "disableToolbar", "onChange", "openTo", "minDate", "maxDate", "ToolbarComponent", "orientation", "shouldDisableMonth", "shouldDisableYear"]);
    ...
    return (React.createElement("div", { className: clsx_1.default(classes.container, (_b = {},
        ...
        React.createElement("div", { className: clsx_1.default(classes.pickerView, (_c = {}, _c[classes.pickerViewLandscape] = isLandscape, _c)) },
            openView === 'year' && (React.createElement(YearView_1.YearSelection, __assign({}, rest, { date: date, onChange: handleChangeAndOpenNext, minDate: minDate, maxDate: maxDate, shouldDisableYear: shouldDisableYear }))),
            openView === 'month' && (React.createElement(MonthView_1.MonthSelection, __assign({}, rest, { date: date, onChange: handleChangeAndOpenNext, minDate: minDate, maxDate: maxDate, shouldDisableMonth: shouldDisableMonth }))),
